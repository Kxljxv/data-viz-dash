...
class GraphVisualization {
    ...
    simulatePhysics() {
        ...
        const simulation = d3.forceSimulation(this.nodes)
            ...
            .force('charge', d3.forceManyBody().strength(-200).distanceMin(15).theta(0.2))
            .force('collision', d3.forceCollide().radius(d => (1.2 * (Math.sqrt(d.linkCount) * 1.5 + 0.25) * this.settings.nodeSize)).strength(4).iterations(50))
